...
first two `RUN-004` adapters validate configured PCSX2 against the complete
recovered 73-alternative BIOS group and Xemu against its recovered required
boot-ROM, HDD, and flash-BIOS groups. They read portable or host-native
...
drive/UNC mappings. Other-emulator BIOS adapters, acquisition, configuration
changes, and mutation remain open.
