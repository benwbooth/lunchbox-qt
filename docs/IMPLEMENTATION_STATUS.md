...
The workspace currently has 143 passing Rust tests. Both QML resources are
...
- The manual ROM importer covers the recovered location, platform, leave/copy/
  move, extension, folder-title, duplicate, and editable game-list steps. It
  deliberately refuses stale previews and destination overwrites. Copy/move
  ...
  metadata/media acquisition, emulator/BIOS selection, related-file copying,
  multi-disc combining, MAME/FBNeo branches, cancellation/partial retention,
  and exact 13.27 duplicate/error rules remain open.
