...
registration. Discovery remains read-only. Separate PCSX2, BigPEmu, and Xemu
managers now implement provider-backed install/update/repair lifecycles with
...
and configuration. Other emulator providers,
...
The workspace currently has 322 passing Rust tests. Both QML frontends and the
