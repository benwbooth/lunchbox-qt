...
registration. Discovery remains read-only. Separate PCSX2 and BigPEmu managers
now implement provider-backed install/update/repair lifecycles with
...
desktop helper from both installation and execution. Other emulator providers,
...
The workspace currently has 316 passing Rust tests. Both QML frontends and the
