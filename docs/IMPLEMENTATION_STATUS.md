...
The workspace currently has 149 passing Rust tests. Both QML resources are
...
- The manual ROM importer covers the recovered location, platform, emulator,
  ...
  destination overwrites. Complete, contiguous, collision-free `(Disc N)` and
  ...
  handling, related-file copying, metadata/database-driven version combining,
  broader disc-name grammars, MAME/FBNeo branches, cancellation/partial
  retention, and exact 13.27 duplicate/error rules remain open.
