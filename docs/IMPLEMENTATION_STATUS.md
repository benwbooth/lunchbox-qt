...
The workspace currently has 163 passing Rust tests. Both QML resources are
...
- The manual ROM importer covers the recovered location, platform, emulator,
  ...
  and parenthetical qualifier preference, refuses to guess among multiple
  matches, and persists a unique match's typed text/player/date/URL/rating
  fields. The recovered PDF option scans the main game folder without
  ...
  Fuzzy or interactive matching, metadata/online-media acquisition, emulator
